...
<body class="pb-80">
    ...
    <div class="container">
        ...
        <div class="quick-actions">
            ...
            <a href="index.php?url=scoreboard/index" class="btn btn-secondary"><i class="fa-solid fa-trophy"></i>
                RANK</a>
        </div>
        ...
        <!-- Suggestion Card -->
        <div class="result-box bg-secondary color-white mt-1 text-center p-1 border-black">
            <h3 class="color-white mb-05 no-shadow"><i class="fa-solid fa-lightbulb"></i> SARAN WAIFU BARU?</h3>
            <p class="text-xs opacity-08 mb-1">Punya waifu favorit yang belum ada? Kasih tahu kami!</p>
            <a href="https://forms.gle/uV83B7zRbk98sKDr6" target="_blank" class="btn bg-accent2 mb-0 w-auto px-3">ISI
                FORM SARAN</a>
        </div>
            ...
            <form action="index.php" method="GET"
                ...
                <div style="flex: 1; min-width: 150px;">
                    ...
                    <input type="text" name="search" value="<?php echo htmlspecialchars($filters['search']); ?>"
                        placeholder="..." style="margin-bottom: 0; padding: 0.5rem; font-size: 0.8rem;">
                </div>

                <div style="width: 80px;">
                    <label class="text-xs font-black">TIER</label>
                    <select name="tier" class="btn"
                        style="margin-bottom: 0; padding: 0.5rem; font-size: 0.8rem; background: var(--white); color: var(--black); text-transform: none; text-align: left;">
                ...
                <button type="submit" class="btn w-auto mb-0" style="padding: 0.5rem 0.8rem;"><i
                        class="fa-solid fa-magnifying-glass"></i></button>
                <a href="index.php?url=gacha/index" class="btn btn-secondary w-auto mb-0"
                    style="padding: 0.5rem 0.8rem;"><i class="fa-solid fa-rotate-left"></i></a>
            </form>
        </div>
        ...
        <div class="collection-grid">
            <?php foreach ($waifus as $w): ?>
                <div class="result-box waifu-card-mini">
                    ...
                    <img src="<?php echo htmlspecialchars($w['image_url']); ?>" loading="lazy"
                        class="waifu-img m-0 w-full border-3">
        ...
        <a href="index.php?url=auth/logout" class="btn mt-3 bg-555"><i class="fa-solid fa-right-from-bracket"></i>
            LOGOUT</a>
    </div>
        ...
        <div class="modal-content">
            ...
            <form action="index.php?url=gacha/sellWaifu" method="POST" class="mt-1">
                ...
                <div style="display: flex; gap: 0.5rem; align-items: center; margin-bottom: 1rem;">
                    <input type="number" name="quantity" id="modalInputQty" value="1" min="1" class="mb-0"
                        oninput="updateSellPrice()">
                </div>

                <div class="result-box bg-white color-black p-05 border-black no-shadow text-center"
                    style="min-height: auto;">
                    <div class="text-xs opacity-06">TOTAL HARGA</div>
                    <div class="text-xl font-black color-accent2"><i class="fa-solid fa-coins"></i> <span
                            id="modalTotalPrice">0</span></div>
                </div>
